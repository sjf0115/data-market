...
/**
 * 功能：如果位图有任何公共元素则返回 true，否则返回 false。 对于空位图，返回 false
 * 作者：SmartSi
 * CSDN博客：https://smartsi.blog.csdn.net/
 * 公众号：大数据生态
 * 日期：2024/5/17 06:51
 */
public class RbmBitmapHasAnyUDF extends GenericUDF {
    private static String functionName = "rbm_bitmap_has_any";
