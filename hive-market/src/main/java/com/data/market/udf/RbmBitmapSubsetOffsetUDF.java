 ...
 * 日期：2024/5/25 11:54
 */
public class RbmBitmapSubsetOffsetUDF extends GenericUDF {
    private static String functionName = "rbm_bitmap_subset_offset";
    ...
    public Object evaluate(DeferredObject[] deferredObjects) throws HiveException {
        ...
        long offset = PrimitiveObjectInspectorUtils.getLong(deferredObjects[1].get(), this.inspector1);
        ...
        try {
            ...
            bitmap.subsetOffset(offset, limit);
    ...
    public String getDisplayString(String[] children) {
        // 这里返回函数及其参数的描述
        return functionName + "(offset, limit)";
    }
}
