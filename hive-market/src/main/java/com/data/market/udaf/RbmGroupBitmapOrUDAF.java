...
/**
 * 功能：计算 Bitmap 列的并集(或操作)，并返回一个新的位图 Bitmap
 * 作者：SmartSi
 * CSDN博客：https://smartsi.blog.csdn.net/
 * 公众号：大数据生态
 * 日期：2024/5/23 22:11
 */
public class RbmGroupBitmapOrUDAF extends AbstractGenericUDAFResolver {
    private static String functionName = "rbm_group_bitmap_or";
    @Override
