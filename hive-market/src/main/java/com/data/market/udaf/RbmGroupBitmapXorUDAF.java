...
/**
 * 功能：计算 Bitmap 列的不重复元素所构成的集合，并返回一个新的位图 Bitmap
 * 作者：SmartSi
 * CSDN博客：https://smartsi.blog.csdn.net/
 * 公众号：大数据生态
 * 日期：2024/5/23 22:11
 */
public class RbmGroupBitmapXorUDAF extends AbstractGenericUDAFResolver {
    private static String functionName = "rbm_group_bitmap_xor";
    @Override
    ...
    public static class MergeEvaluator extends GenericUDAFEvaluator {
        ...
        public void iterate(AggregationBuffer agg, Object[] parameters) throws HiveException {
            ...
            try {
                ...
                bitmapAggBuffer.bitmap.xor(bitmap);
            } catch (Exception e) {
